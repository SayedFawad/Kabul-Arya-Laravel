...
<body>
  <center>
   <div id="div">
<br />
    <a href="/expenses" class="button">Back</a>



    <form action="save_expenses" method="post" id="insertForm" enctype="multipart/form-data">
     {{ csrf_field() }}
        <br >
        ...
        <table>
              <tr>
               <td>AccountID</td>
                <td><input type="text" name="AccountID" id="AccountID" value="{{$varTbl->ID}}" /> {{$varTbl->Name}}</td>
