...
<title>Control Panel - product</title>
...
<div style="position:absolute;left:10px;top:364px;width:970px;height:900px;z-index:2;background-color:#FFFFFF;border:1px solid #efefef;border-radius:4px;">
 ...
 <br /><br />
<a href="insert_product">New Product</a>
      ...
      <tbody>
         @foreach($tableVar as $tbl)
          <tr>
               ...
               <td><img src="{{$tbl->pic1}}" style="width:100px;height:100px;"></td>
               <td>{{$tbl->Description}}</td>
               
               

               <td > <a class="button" href="edit_product&{{$tbl->id}}">Edit</a> </td>
               <td> <a class="button-delete" href="delete_product&{{$tbl->id}}">Delete</a>  </td>
          </tr>
          @endforeach
      </tbody>
   </table>
