...
<div style="position:absolute;left:100px;top:364px;width:800px;height:900px;z-index:2;background-color:#FFFFFF;border:1px solid #efefef;border-radius:4px;">
 ...
 <br /><br />
     ...
     <table>
          <tr>
              <td colspan="4" style="text-align:center"> <font style="font-size:20px;">  {{$infoTest->Item}}</font></td>
          </tr>
          <tr >
             <td> &nbsp;</td>
           </tr>
          <tr>
              <td class="pic"> <img src="{{$infoTest->Picture}}" style="width:390px;height:440px;" /> </td>
              <td class="pic"> <img src="{{$infoTest->pic1}}" style="width:390px;height:440px;" /></td>
              
          </tr>
          <tr>
                <td colspan="4" style="text-align:center">  <font style="font-size:20px;">  {{$infoTest->Description}}</font></td>
          </tr>
     </table>
