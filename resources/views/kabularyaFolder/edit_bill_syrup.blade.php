...
<br />
        ...
        <a href="bill_syrup" class="button">Back</a>

 <form action="update_bill_syrup&{{$varTbl->ID}}" method="post">
       {{ csrf_field() }}
        <br >
        ...
        <table>
          <tr>
               ...
               <tr>
                <td>Bill No</td>
                <td>
                    <input type="text" name="Bill_No" id="Bill_No" value="{{$varTbl->Bill_No}}" />
                </td>
              </tr>
              <tr>
                <td>Date</td>
              ...
              <tr>
                <td>Price</td>
                <td>
                    <input type="text" name="Price" id="Price" value="{{$varTbl->Price}}" />
                </td>
              </tr>
            <tr>
               <td>Description</td>
