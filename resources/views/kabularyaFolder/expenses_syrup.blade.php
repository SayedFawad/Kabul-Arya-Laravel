...
<div style="position:absolute;left:10px;top:364px;width:970px;height:900px;z-index:2;background-color:#FFFFFF;border:1px solid #efefef;border-radius:4px;">
 ...
 <br /><br />
<a href="insert_expenses_syrup">New Expenses</a>
      ...
      <tbody>
         @foreach($tableVar as $tbl)
          <tr>
               ...
               <td > <a class="button" href="edit_expenses_syrup&{{$tbl->ID}}">Edit</a> </td>
               <td> <a class="button-delete" href="delete_expenses_syrup&{{$tbl->ID}}">Delete</a>  </td>
          </tr>
          @endforeach
      </tbody>
   </table>
