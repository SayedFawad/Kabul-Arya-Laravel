...
<div style="position:absolute;left:10px;top:364px;width:970px;height:900px;z-index:2;background-color:#FFFFFF;border:1px solid #efefef;border-radius:4px;">
 ...
 <br /><br />
 <h2>
<a href="insert_money_received_syrup">Received Money</a>
</h2>
      ...
      <tbody>
         @foreach($tableVar as $tbl)
          ...
          <tr>
               ...
               <td > <a class="button" href="edit_money_received_syrup&{{$tbl->ID}}">Edit</a> </td>
               <td> <a class="button-delete" href="delete_money_received_syrup&{{$tbl->ID}}">Delete</a>  </td>
          </tr>
          @endforeach
